...
const releasedEpisode = function (curre) {
    return `<a href=" https://www.2embed.to/embed/tmdb/tv?id=${fetcid}&s=${curre.season_number
...
<h2 class="episode_title"> <span class="episodenumm">${curre.episode_number
        }.</span> ${curre.name}</h2>
...
const unreleasedEpisodev = function (curre) {
    return `<a class="unreleased_link" href=" https://www.2embed.to/embed/tmdb/tv?id=${fetcid}&s=${curre.season_number
